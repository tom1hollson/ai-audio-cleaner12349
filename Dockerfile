# 1. Base Python system lana (Ab hum sabse stable Python 3.11 use karenge)
FROM python:3.11-slim

# 2. System ko update karna aur FFmpeg, Cargo, plus Audio Drivers install karna
...
# 5. PyTorch 2.1.2 CPU version install karna (Ab yeh 100% chalega)
