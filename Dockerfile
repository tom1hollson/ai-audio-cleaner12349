...
# 2. System ko update karna aur zaroori tools install karna
...
# 5. PyTorch aur Audio Reader (soundfile) install karna
RUN pip install --no-cache-dir torch==2.1.2 torchaudio==2.1.2 soundfile --index-url https://download.pytorch.org/whl/cpu
